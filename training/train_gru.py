...
def train_gru(
    ...
    print(f"Параметры: hidden_size={hidden_size}, num_layers={num_layers}, dropout={dropout}")
        ...
        if val_acc > history['best_acc']:
            ...
            if save_checkpoints:
                ...
                save_checkpoint(
                    ...
                    checkpoint_path,
                    additional_info={'model_config': model.get_config()}
                )
    ...
    print(f"Лучшая точность на валидации: {history['best_acc']:.2f}% на эпохе {history['best_epoch']}")
